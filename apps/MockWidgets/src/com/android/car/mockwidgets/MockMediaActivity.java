...
public class MockMediaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_fullscreen).setOnClickListener(v -> {
            sendFocusBroadcast("event_toggle_fullscreen_media");
        });

        // Draggable Favorite Icon
        ImageView albumArtIcon = findViewById(R.id.album_art_icon);
        albumArtIcon.setOnLongClickListener(v -> {
            ClipData data = ClipData.newPlainText("favorite", "scalableui:favorite:media");
            View.DragShadowBuilder shadowBuilder = new View.DragShadowBuilder(v);
            v.startDragAndDrop(data, shadowBuilder, null, View.DRAG_FLAG_GLOBAL);
            return true;
        });
